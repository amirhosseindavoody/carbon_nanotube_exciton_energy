...
cnt_band_structure_mod.o: cnt_class.o comparams.o math_functions_mod.o physical_constant_mod.o write_log_mod.o
cnt_geometry_mod.o: comparams.o math_functions_mod.o physical_constant_mod.o write_log_mod.o
comparams.o: cnt_class.o
dielectric_fn_mod.o: cnt_band_structure_mod.o comparams.o math_functions_mod.o physical_constant_mod.o write_log_mod.o
interpolate_mod.o: cnt_band_structure_mod.o comparams.o math_functions_mod.o write_log_mod.o
E_exciton_energy_mod.o: comparams.o math_functions_mod.o write_log_mod.o
main.o: A_exciton_energy_mod.o cnt_band_structure_mod.o cnt_geometry_mod.o dielectric_fn_mod.o E_exciton_energy_mod.o interpolate_mod.o parse_input_file_mod.o self_energy_mod.o write_log_mod.o
