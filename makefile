...
exciton_energy_mod.o: comparams.o math_functions_mod.o write_log_mod.o
main.o: cnt_band_structure_mod.o cnt_geometry_mod.o dielectric_fn_mod.o exciton_energy_mod.o parse_input_file_mod.o self_energy_mod.o write_log_mod.o
