...
echo nkg = %nkg%
echo E_th= %E_th%
start C:\Amirhossein\CarbonNanotube-ExcitonEnergy\Release\CNT_Exciton_Energy.exe ch %n_ch% %m_ch% flg_dielectric %flg_dielectric% nkg %nkg% E_th %E_th% i_sub %i_sub%
