...
#include <boost/numeric/ublas/io.hpp>	// for boost::numeric::ublas vector and matrix cout
...
cnt::cnt()
{
	...
	m = 0;
	name = "no_name";
	length_in_cnt_unit_cell = 0;
}

cnt::cnt(const char *in_name, int in_n, int in_m, int in_length)
{
	name = in_name;
	n = in_n;
	m = in_m;
